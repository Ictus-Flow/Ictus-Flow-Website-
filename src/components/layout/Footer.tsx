    ...
    <footer className="bg-slate-950 py-12 border-t border-white/10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center relative z-10">
        ...
        <div className="flex items-center mb-4 md:mb-0 group cursor-pointer">
          ...
          <span className="text-xl font-bold text-slate-300 group-hover:text-white transition-colors tracking-tight">
            Ictus Flow
          </span>
        </div>
        ...
        <div className="flex space-x-6">
          <a
            href="#"
            className="text-slate-500 hover:text-pink-400 transition-colors transform hover:scale-110 hover:drop-shadow-[0_0_8px_rgba(236,72,153,0.4)]"
            aria-label="LinkedIn"
          >
          ...
          <a
            href="#"
            className="text-slate-500 hover:text-cyan-400 transition-colors transform hover:scale-110 hover:drop-shadow-[0_0_8px_rgba(6,182,212,0.4)]"
            aria-label="Twitter"
          >
          ...
          <a
            href="#"
            className="text-slate-500 hover:text-indigo-400 transition-colors transform hover:scale-110 hover:drop-shadow-[0_0_8px_rgba(99,102,241,0.4)]"
            aria-label="Email"
          >
