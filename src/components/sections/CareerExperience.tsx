...
export const CareerExperience = () => {
  return (
    <section className="py-24 bg-slate-950 relative overflow-hidden border-y border-white/5">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-emerald-900/10 blur-[120px] rounded-full"></div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        {/* Header */}
        <RevealOnScroll>
          <div className="text-center mb-16">
            <h2 className="text-transparent bg-clip-text bg-gradient-to-r from-slate-400 to-slate-300 font-black tracking-widest uppercase text-sm mb-3">
        ...
        <RevealOnScroll className="delay-100">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {projectTypes.map((type, idx) => (
              ...
              >
                <div
                  className={`w-14 h-14 rounded-xl bg-gradient-to-br ${type.color} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform shadow-lg`}
                >
        ...
        <RevealOnScroll className="delay-200">
          <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-8 border border-white/10 shadow-[0_8px_32px_0_rgba(0,0,0,0.37)]">
            <h4 className="text-white font-bold text-center mb-8 text-sm tracking-widest uppercase text-slate-400">
            ...
            <div className="relative w-full overflow-hidden">
              {/* Gradient Fades */}
              <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-slate-950/80 to-transparent z-10 pointer-events-none"></div>
              <div className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-slate-950/80 to-transparent z-10 pointer-events-none"></div>

              {/* Scrolling Track - using inline-flex and gap for precise spacing */}
              <div className="inline-flex gap-16 animate-scroll-smooth">
                {/* First set of logos */}
