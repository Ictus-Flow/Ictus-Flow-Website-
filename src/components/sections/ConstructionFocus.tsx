    ...
    <section id="solutions" className="py-24 bg-slate-950 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <RevealOnScroll>
          <div className="text-center mb-12">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-6 shadow-[0_8px_32px_0_rgba(245,158,11,0.1)] animate-pulse-slow">
              ...
              <span className="text-amber-200 text-sm font-black tracking-wide uppercase">
            ...
            <p className="text-amber-100/70 text-lg mb-8 leading-relaxed font-medium max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* RAMS Analysis */}
          <div className="flex flex-col items-center text-center group p-6 rounded-xl transition-all hover:bg-white/5 border border-transparent hover:border-white/5 backdrop-blur-sm">
            <div className="relative w-14 h-14 rounded-lg flex items-center justify-center mb-4 overflow-hidden ring-1 ring-amber-600/50 shadow-md shadow-amber-900/20">
              <div className="absolute inset-0 bg-gradient-to-br from-amber-500/70 to-orange-600/70 blur-md"></div>
              <AlertTriangle className="text-white w-7 h-7 relative z-10 drop-shadow-sm" />
            </div>
            <h4 className="text-white font-bold text-lg group-hover:text-amber-400 transition-colors mb-2">
              RAMS Analysis
            </h4>
          ...
          <div className="flex flex-col items-center text-center group p-6 rounded-xl transition-all hover:bg-white/5 border border-transparent hover:border-white/5 backdrop-blur-sm">
            <div className="relative w-14 h-14 rounded-lg flex items-center justify-center mb-4 overflow-hidden ring-1 ring-amber-600/50 shadow-md shadow-amber-900/20">
              <div className="absolute inset-0 bg-gradient-to-br from-amber-500/70 to-orange-600/70 blur-md"></div>
              <Mic className="text-white w-7 h-7 relative z-10 drop-shadow-sm" />
            </div>
            <h4 className="text-white font-bold text-lg group-hover:text-amber-400 transition-colors mb-2">
          ...
          <div className="flex flex-col items-center text-center group p-6 rounded-xl transition-all hover:bg-white/5 border border-transparent hover:border-white/5 backdrop-blur-sm">
            <div className="relative w-14 h-14 rounded-lg flex items-center justify-center mb-4 overflow-hidden ring-1 ring-amber-600/50 shadow-md shadow-amber-900/20">
              <div className="absolute inset-0 bg-gradient-to-br from-amber-500/70 to-orange-600/70 blur-md"></div>
              <FileText className="text-white w-7 h-7 relative z-10 drop-shadow-sm" />
            </div>
            <h4 className="text-white font-bold text-lg group-hover:text-amber-400 transition-colors mb-2">
          ...
          <div className="flex flex-col items-center text-center group p-6 rounded-xl transition-all hover:bg-white/5 border border-transparent hover:border-white/5 backdrop-blur-sm">
            <div className="relative w-14 h-14 rounded-lg flex items-center justify-center mb-4 overflow-hidden ring-1 ring-amber-600/50 shadow-md shadow-amber-900/20">
              <div className="absolute inset-0 bg-gradient-to-br from-amber-500/70 to-orange-600/70 blur-md"></div>
              <Mail className="text-white w-7 h-7 relative z-10 drop-shadow-sm" />
            </div>
            <h4 className="text-white font-bold text-lg group-hover:text-amber-400 transition-colors mb-2">
              Email Summary Automation
            </h4>
          ...
          <div className="flex flex-col items-center text-center group p-6 rounded-xl transition-all hover:bg-white/5 border border-transparent hover:border-white/5 backdrop-blur-sm">
            <div className="relative w-14 h-14 rounded-lg flex items-center justify-center mb-4 overflow-hidden ring-1 ring-amber-600/50 shadow-md shadow-amber-900/20">
              <div className="absolute inset-0 bg-gradient-to-br from-amber-500/70 to-orange-600/70 blur-md"></div>
              <CheckSquare className="text-white w-7 h-7 relative z-10 drop-shadow-sm" />
            </div>
            <h4 className="text-white font-bold text-lg group-hover:text-amber-400 transition-colors mb-2">
              QA File Checking
            </h4>
          ...
          <div className="flex flex-col items-center text-center group p-6 rounded-xl transition-all hover:bg-white/5 border border-transparent hover:border-white/5 backdrop-blur-sm">
            <div className="relative w-14 h-14 rounded-lg flex items-center justify-center mb-4 overflow-hidden ring-1 ring-amber-600/50 shadow-md shadow-amber-900/20">
              <div className="absolute inset-0 bg-gradient-to-br from-amber-500/70 to-orange-600/70 blur-md"></div>
              <FileSearch className="text-white w-7 h-7 relative z-10 drop-shadow-sm" />
            </div>
            <h4 className="text-white font-bold text-lg group-hover:text-amber-400 transition-colors mb-2">
              Tender Gap Analysis
            </h4>
          ...
          <div className="flex flex-col items-center text-center group p-6 rounded-xl transition-all hover:bg-white/5 border border-transparent hover:border-white/5 backdrop-blur-sm">
            <div className="relative w-14 h-14 rounded-lg flex items-center justify-center mb-4 overflow-hidden ring-1 ring-amber-600/50 shadow-md shadow-amber-900/20">
              <div className="absolute inset-0 bg-gradient-to-br from-amber-500/70 to-orange-600/70 blur-md"></div>
              <PenTool className="text-white w-7 h-7 relative z-10 drop-shadow-sm" />
            </div>
            <h4 className="text-white font-bold text-lg group-hover:text-amber-400 transition-colors mb-2">
              Document Preparation Assistant
            </h4>
          ...
          <div className="flex flex-col items-center text-center group p-6 rounded-xl transition-all hover:bg-white/5 border border-transparent hover:border-white/5 backdrop-blur-sm">
            <div className="relative w-14 h-14 rounded-lg flex items-center justify-center mb-4 overflow-hidden ring-1 ring-amber-600/50 shadow-md shadow-amber-900/20">
              <div className="absolute inset-0 bg-gradient-to-br from-amber-500/70 to-orange-600/70 blur-md"></div>
              <FileCheck className="text-white w-7 h-7 relative z-10 drop-shadow-sm" />
            </div>
            <h4 className="text-white font-bold text-lg group-hover:text-amber-400 transition-colors mb-2">
              Contract Compliance Review
            </h4>
          ...
          <div className="flex flex-col items-center text-center group p-6 rounded-xl transition-all hover:bg-white/5 border border-transparent hover:border-white/5 backdrop-blur-sm">
            <div className="relative w-14 h-14 rounded-lg flex items-center justify-center mb-4 overflow-hidden ring-1 ring-amber-600/50 shadow-md shadow-amber-900/20">
              <div className="absolute inset-0 bg-gradient-to-br from-amber-500/70 to-orange-600/70 blur-md"></div>
              <GitCompare className="text-white w-7 h-7 relative z-10 drop-shadow-sm" />
            </div>
            <h4 className="text-white font-bold text-lg group-hover:text-amber-400 transition-colors mb-2">
              Change Order Validation
            </h4>
        ...
        <p className="text-amber-100/70 text-lg mt-12 leading-relaxed font-medium max-w-4xl mx-auto text-center">
